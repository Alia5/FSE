...
namespace fse
{
    ...
    std::vector<sf::Packet> NetworkHandler::getUdpPackets(const std::string_view& objectID)
    {
    ...
    std::vector<sf::Packet> NetworkHandler::getTcpPackets(const std::string_view& objectID)
    {
        std::vector<sf::Packet> packs;
        mtx_.lock();
